...
Workdir = 'work_dirs/local-exp500/'

def parse_args():
    parser = argparse.ArgumentParser(
        description='mmseg test (and eval) a model')
    parser.add_argument('--config',default=Workdir+'config.json',
    ...
    parser.add_argument(
        ...
        default='same',
        help='Inference mode.')
    parser.add_argument('--dataset', default='Mapillary')
    parser.add_argument(
        '--model',
        choices=[
            'model',
